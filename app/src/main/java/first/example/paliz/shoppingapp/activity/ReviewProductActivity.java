...
import first.example.paliz.shoppingapp.adapter.PropertiesProductAdapter;
import first.example.paliz.shoppingapp.adapter.ReviewProductAdapter;
import first.example.paliz.shoppingapp.model.OptionProduct;
import first.example.paliz.shoppingapp.model.ReviewProduct;
