...
import first.example.paliz.shoppingapp.activity.AllProductActivity;
import first.example.paliz.shoppingapp.adapter.AmazingProductAdapter;
import first.example.paliz.shoppingapp.adapter.BannerSecondAdapter;
import first.example.paliz.shoppingapp.adapter.BrandAdapter;
import first.example.paliz.shoppingapp.adapter.CategoryAdapter;
import first.example.paliz.shoppingapp.adapter.NewProductAdapter;
import first.example.paliz.shoppingapp.adapter.SliderAdapter;
import first.example.paliz.shoppingapp.adapter.WatchProductAdapter;
...
import first.example.paliz.shoppingapp.model.Banner;
...
import first.example.paliz.shoppingapp.model.TimerAmazing;
