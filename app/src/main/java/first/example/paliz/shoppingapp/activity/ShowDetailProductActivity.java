...
import first.example.paliz.shoppingapp.adapter.CommentLimitAdapter;
import first.example.paliz.shoppingapp.adapter.ImageProductAdapter;
import first.example.paliz.shoppingapp.adapter.OptionProductAdapter;
import first.example.paliz.shoppingapp.adapter.SimilarProductAdapter;
...
import first.example.paliz.shoppingapp.database.Local.FavoriteDao;
...
import first.example.paliz.shoppingapp.model.Comment;
import first.example.paliz.shoppingapp.model.ImageProduct;
import first.example.paliz.shoppingapp.model.OptionProduct;
...
public class ShowDetailProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                layout_share.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        intent.putExtra(Intent.EXTRA_SUBJECT , "اپلیکیشن فزوشگاهی");
                        String message = "اسم محصول : " + name_product;
                        intent.putExtra(Intent.EXTRA_TEXT , message);
                        startActivity(Intent.createChooser(intent , "اپلیکیشن فزوشگاهی"));
        ...
        switch (IMG_FAVORITE) {
           ...
           if(IMG_FAVORITE==SEEN){
            img_favorite.setImageResource(R.drawable.ic_baseline_favorite_24);
        }else if (IMG_FAVORITE==NO_SEEN){
            img_favorite.setImageResource(R.drawable.ic_baseline_favorite_border_24);
        }
