...
import first.example.paliz.shoppingapp.adapter.FilterBrandAdapter;
import first.example.paliz.shoppingapp.adapter.FilterCategoryAdapter;
import first.example.paliz.shoppingapp.model.Brand;
import first.example.paliz.shoppingapp.model.Category;
import first.example.paliz.shoppingapp.model.Intro;
